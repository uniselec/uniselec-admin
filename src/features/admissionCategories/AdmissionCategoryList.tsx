...
import { useGetAdmissionCategoriesQuery } from "./admissionCategorySlice";
import { GridFilterModel } from "@mui/x-data-grid";
import { useState } from "react";
import { useAppSelector } from "../../app/hooks";
import { selectAuthUser } from "../auth/authSlice";
import { AdmissionCategoryTable } from "./components/AdmissionCategoryTable";

export const AdmissionCategoryList = () => {
  ...
  const { data, isFetching, error } = useGetAdmissionCategoriesQuery(options);
