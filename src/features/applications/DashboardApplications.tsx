      ...
      <Card elevation={3}>
        <CardContent>
          <Typography variant="h6" gutterBottom>
            Downloads de Resultados por Modalidade
          </Typography>
          <Box display="flex" flexDirection="column">
            <Button variant="contained" color="primary" sx={{ marginBottom: 1 }} href="/download/modalidade-a">
              Modalidade A
            </Button>
            <Button variant="contained" color="primary" sx={{ marginBottom: 1 }} href="/download/modalidade-b">
              Modalidade B
            </Button>
            <Button variant="contained" color="primary" href="/download/modalidade-c">
              Modalidade C
            </Button>
          </Box>
        </CardContent>
